package org.firstinspires.ftc.teamcode.rewriting;
...
public class LessBadSkystoneDetector extends SkystoneDetector {
    ...
    public LessBadSkystoneDetector() {
        detectorName = "Less Bad Skystone Detector";
    }
    ...
    public Mat process(Mat input) {
        ...
        Imgproc.drawContours(displayMat, contoursYellow,-1,new Scalar(255,30,30),1);
        ...
        for(MatOfPoint cont : contoursYellow){
            ...
            Imgproc.rectangle(displayMat, rect.tl(), rect.br(), new Scalar(0,0,255),1); // Draw rect
        ...
        Imgproc.drawContours(displayMat,contoursBlack,-1,new Scalar(40,40,40),1);
        ...
        if(bestRect != null) {
            // Show chosen result
            Imgproc.rectangle(displayMat, bestRect.tl(), bestRect.br(), new Scalar(0,255,255),2);
            Imgproc.putText(displayMat, "Chosen", bestRect.tl(),0,0.5,new Scalar(255,255,255));
